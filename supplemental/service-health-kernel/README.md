# Service Health Kernel Laboratory
...
A health/readiness kernel that separates liveness from readiness, tracks dependency state, and models graceful drain behavior.
