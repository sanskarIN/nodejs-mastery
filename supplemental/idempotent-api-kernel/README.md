# Idempotent API Kernel Laboratory
...
A small API-effect kernel that models idempotency keys, request fingerprints, replay-safe results, conflict detection, and bounded record retention.
