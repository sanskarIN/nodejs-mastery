# Token Bucket Gateway Laboratory
...
A dependency-free token-bucket rate limiter with per-key isolation, refill math, retry-after calculation, and bounded bucket cleanup.
